...
# AZHAR MANIE | Personal Portfolio Website

A modern, high-end personal portfolio website built to showcase my transition from the culinary arts into software development. This project demonstrates foundational web development concepts, responsive design, and a clean user experience.
...
### Purpose
The purpose of this website is to introduce who I am, display my growing technical skillset, and document my learning journey. It bridges my background in precision-based culinary environments with my current focus on writing clean, efficient, and semantic code.

### Website Sections
The site is built as a cohesive digital showcase featuring:
...
html-css-portfolio/
│
├── index.html          # Main landing page & core structure
├── css/
│   └── style.css       # External stylesheet containing custom animations & styles
├── images/
│   └── screenshot.png  # Project display asset for documentation
└── README.md           # Project documentation and brief overview